    ...
    <AnimatedSection className="py-32 px-6 md:px-12 lg:px-24">
      <div className="w-full max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            <h2 className="text-2xl font-semibold mb-16 text-earth-dark">Trusted By</h2>
          ...
          <div className="space-y-16">
            ...
            > {/*
              <span className="text-earth-dark text-lg font-normal">Google</span>
              <span className="text-earth-dark text-lg font-normal">Stripe</span>
              <span className="text-earth-dark text-lg font-normal">Airbnb</span>
              <span className="text-earth-dark text-lg font-normal">Shopify</span>
              <span className="text-earth-dark text-lg font-normal">Vercel</span> */}
            </div>
